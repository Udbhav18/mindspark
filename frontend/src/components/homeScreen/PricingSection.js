                ...
                <div className="row gy-4" data-aos="fade-left">
                    ...
                    <div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                        <div className="box">
                            ...
                            <img src="assets/img/pricing-free.png" className="img-fluid" alt=""></img>
                            <ul>
                                <li>Aida dere</li>
                    ...
                    <div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                        <div className="box">
                            ...
                            <img src="assets/img/pricing-starter.png" className="img-fluid" alt=""></img>
                            <ul>
                                <li>Aida dere</li>
                                <li>Nec feugiat nisl</li>
                                <li>Nulla at volutpat dola</li>
                    ...
                    <div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
                        <div className="box">
                            ...
                            <img src="assets/img/pricing-business.png" className="img-fluid" alt=""></img>
                            <ul>
                                <li>Aida dere</li>
                                <li>Nec feugiat nisl</li>
                                <li>Nulla at volutpat dola</li>
                    ...
                    <div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
                        <div className="box">
                            ...
                            <img src="assets/img/pricing-ultimate.png" className="img-fluid" alt=""></img>
                            <ul>
                                <li>Aida dere</li>
                                <li>Nec feugiat nisl</li>
                                <li>Nulla at volutpat dola</li>
